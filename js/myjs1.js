...
$(document).on("click","#startQuiz", function(){
	  ...
	  Swal.fire({
      title: 'Are you sure?',
      text: 'You want to take this exam now, Or See the video first? ',
      icon: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#3085d6',
      cancelButtonColor: '#d33',
      cancelButtonText: 'Not yet i have to review first',
         ...
         $.ajax({
          ...
          success : function(data){
            if(data.res == "alreadyExam")
            {
              Swal.fire(
                'Already Taken ',
                'you already take this exam please do arequest for a retake',
            ...
            {
              window.location.href="exam.php?id="+thisId;
              return false;
            }
          },
