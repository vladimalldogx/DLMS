...
<form method="post" id="updateCourseFrm">
  ...
  <div class="form-group">
      <legend>Edit Capacity</legend>
  
    <input type="" name="ecap" class="form-control" required="" value="<?php echo $selCourse['stu_capacity']; ?>" >
  </div>
  <div class="form-group">
      <legend>Set Min exam Pass</legend>
  
    <input type="" name="minpass" class="form-control" required="" value="<?php echo $selCourse['minexam_pass']; ?>" >
  </div>
