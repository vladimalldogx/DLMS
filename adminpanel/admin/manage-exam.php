                                          ...
                                          <?php 
                                            ...
                                            if($selQuest->rowCount() > 0)
                                            {
                                               ...
                                               while ($selQuestionRow = $selQuest->fetch(PDO::FETCH_ASSOC)) { 
                                                 $selectedimage = $selQuestionRow ['exam_photo'];
                                                 if(!empty($selectedimage)){
                                                 $tgtimage="<img src='./assets/uploads/examquestion/$selectedimage'alt='$selectedimage?' width='50' height='60'>";
                                                 } else{
                                                 $tgtimage ="";
                                                ...
                                                <tr>
                                                        <td >
                                                            <b><?php echo $i++ ; ?> .) <?php echo htmlentities($selQuestionRow['exam_question']); ?></b><br>
                                                            <?=$tgtimage?>
                                                            <br>
                                                            <?php 
                                                              // Choice A
                                                              ...
                                                              { ?>
                                                                <span class="pl-4 text-success">A - <?php echo  htmlentities($selQuestionRow['exam_ch1']); ?></span><br>
                                                              <?php }
                                                              else
                                                              { ?>
                                                                <span class="pl-4">A - <?php echo htmlentities ($selQuestionRow['exam_ch1']); ?></span><br>
                                                              <?php }

                                                              // Choice B
                                                              if($selQuestionRow['exam_ch2'] == $selQuestionRow['exam_answer'])
                                                              { ?>
                                                                <span class="pl-4 text-success">B - <?php echo htmlentities($selQuestionRow['exam_ch2']); ?></span><br>
                                                              <?php }
                                                              else
                                                              { ?>
                                                                <span class="pl-4">B - <?php echo htmlentities($selQuestionRow['exam_ch2']); ?></span><br>
                                                              <?php }

                                                              // Choice C
                                                              if($selQuestionRow['exam_ch3'] == $selQuestionRow['exam_answer'])
                                                              { ?>
                                                                <span class="pl-4 text-success">C - <?php echo htmlentities($selQuestionRow['exam_ch3']); ?></span><br>
                                                              <?php }
                                                              else
                                                              { ?>
                                                                <span class="pl-4">C - <?php echo htmlentities($selQuestionRow['exam_ch3']); ?></span><br>
                                                              <?php }

                                                              // Choice D
                                                              if($selQuestionRow['exam_ch4'] == $selQuestionRow['exam_answer'])
                                                              { ?>
                                                                <span class="pl-4 text-success">D - <?php echo htmlentities($selQuestionRow['exam_ch4']); ?></span><br>
                                                              <?php }
                                                              else
                                                              { ?>
                                                                <span class="pl-4">D - <?php echo htmlentities($selQuestionRow['exam_ch4']); ?></span><br>
                                                              <?php }
