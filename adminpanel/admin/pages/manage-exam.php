        ...
        <div class="app-main__inner">
            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    ...
                    <form method = "POST" >
                        <input type=""  name="search" placeholder="search exam by title">
                    ...
                    <div class="table-responsive">
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                            ...
                            if(isset($_POST['btnsearch'])){
                                $search = $_POST['search'];
                                $selExam = $conn->query("SELECT * FROM exam_tbl WHERE ex_title='$search' ORDER BY ex_id DESC ");
                                if($selExam->rowCount() > 0)
                                {
                                    while ($selExamRow = $selExam->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <tr>
                                            ...
                                            <td >
                                            <a rel="facebox" href="facebox_modal/viewExam.php?id=<?php echo $selExamRow['ex_id']; ?>" class="btn btn-sm btn-info">View</a>
                                ...
                                { ?>
                                    <tr>
                                      <td colspan="5">
                                        <h3 class="p-3">No <?=$search?> Found <a href="home.php?page=manage-exam"> go back</a></h3>
                                      </td>
                                    </tr>
                                <?php }
                            }else{?>
