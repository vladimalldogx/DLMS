...
<div class="app-main__inner">
    ...
    <div class="col-md-12 p-0 mb-4">
        ...
        <?php 
            ...
            //$next = $_GET['id'];
            $selQuest = $conn->query("SELECT * FROM exam_question_tbl WHERE eqt_id='$next' OR  exam_id='$examId' ORDER BY rand() LIMIT $exDisplayLimit ");
            if($selQuest->rowCount() > 0)
            {
                $i = 1;
                while ($selQuestRow = $selQuest->fetch(PDO::FETCH_ASSOC)) { 
                   ...
                   ?>
                    ...
                    <tr>
                        ...
                        <a href="home.php?page=exam?id=<?=$ggez?>">NEXT</a>
                    </tr>
